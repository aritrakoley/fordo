...
CREATE SCHEMA IF NOT EXISTS fordo;
...
CREATE TABLE IF NOT EXISTS fordo.meal_type (
...
CREATE TABLE IF NOT EXISTS fordo.recipe (
	id int4 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE) NOT NULL,
...
CREATE TABLE IF NOT EXISTS fordo.tag (
	id int4 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE) NOT NULL,
...
CREATE TABLE IF NOT EXISTS fordo.ingredient (
	id int4 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE) NOT NULL,
...
CREATE TABLE IF NOT EXISTS fordo.ingredient_local_name (
	id int4 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE) NOT NULL,
...
CREATE TABLE IF NOT EXISTS fordo.note (
	id int4 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE) NOT NULL,
	title varchar NULL,
	body varchar NULL,
...
CREATE TABLE IF NOT EXISTS fordo.recipe_ingredient_map (
	id int4 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE) NOT NULL,
	recipe_id int4 NOT NULL,
	ingredient_id int4 NOT NULL,
	is_active bool NOT NULL,
...
CREATE TABLE IF NOT EXISTS fordo.recipe_meal_type_map (
	id int4 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE) NOT NULL,
	recipe_id int4 NOT NULL,
...
CREATE TABLE IF NOT EXISTS fordo.recipe_step (
	id int4 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE) NOT NULL,
	recipe_id int4 NULL,
...
CREATE TABLE IF NOT EXISTS fordo.recipe_tag_map (
	id int4 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE) NOT NULL,
	recipe_id int4 NOT NULL,
